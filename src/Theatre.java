...
public class Theatre {
    ...
    public static void main(String[] args) {
        ...
        Actor actor1 = new Actor("Валерий", "Жмышенко", 152, Gender.MALE);
        Actor actor2 = new Actor("Максим", "Пышненко", 187, Gender.MALE);
        Actor actor3 = new Actor("Алексей", "Рыжов", 175, Gender.MALE);
        allActors.add(actor1);
        allActors.add(actor2);
        allActors.add(actor3);
        Director director1 = new Director("Александр", "Дзюба", Gender.MALE, 7);
        Director director2 = new Director("Юлия", "Сопина", Gender.FEMALE, 2);
        ...
        Opera opera = new Opera("Дон Жуан", 210, listForDonJuan, director1,
                new Person("Вольфганг", "Моцарт", Gender.MALE),
                "Дон-Жуан в поисках любовных приключений проникает в дом донны Анны", 40);
        Ballet ballet = new Ballet("Лебединое озеро", 83, listForSwanLake, director2,
                new Person("Петр", "Чайковский", Gender.MALE),
                ...
                new Person ("Вацлав", "Резингер", Gender.MALE));
        ...
        ArrayList<MusicalShow> allMusicalShows = new ArrayList<>();
        allMusicalShows.add(opera);
        allMusicalShows.add(ballet);
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                System.out.println("Либретто какого музыкального спектакля вы хотите видеть?");
                String nameOfMusicalShow = scanner.nextLine();
                boolean test = false;

                for (MusicalShow showOfList : allMusicalShows) {
                    if (showOfList.getTitle().equals(nameOfMusicalShow)) {
                        showOfList.printLibrettoText();
                        test = true;
                        break;
                    }
                }
                ...
                for (Show showOfList : allShows) {
                    if (showOfList.getTitle().equals(nameOfShow)) {
                        showOfList.getDirector().directorInformation();
                        test = true;
                        break;
                    }
                }
                ...
                if (!test) {
                    System.out.println("Такого музыкального спектакля нет!");
                }
            } else if (command == 4) {
